...
export class MigrationLocal1750449883679 implements MigrationInterface {
    name = 'MigrationLocal1750449883679'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
      ...
      //  await queryRunner.query(`ALTER TABLE "vehicles" ADD "user_id" integer`);
