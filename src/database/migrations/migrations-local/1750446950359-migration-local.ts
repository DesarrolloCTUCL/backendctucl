...
export class MigrationLocal1750446950359 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "devices" DROP CONSTRAINT "FK_0aecff1eca7dfc6323d316b26f7"`);
        await queryRunner.query(`DROP TABLE "recharge_point"`);
